...
if ($FORM['ucpunlock'] != '') {
    ...
    if ($seskey != '') {
        ...
        $_SESSION['show_msg'] = showalert('danger', 'Ошибка!', 'Неверная сессия');
        $redirval = "?res=errucp";
        $waitme = mt_rand(9, 33);
        echo "<div class='text-center text-small'>Верификация, подождите... <i class='fas fa-cog fa-spin'></i></div>";
    }
...
if (isset($FORM['dosubmit']) && $FORM['dosubmit'] == '1') {
    ...
    if ($rowstr['id'] > 0 && $rowstr['mbrstatus'] <= 3 && password_verify(md5($password), $rowstr['password'])) {
        ...
        $_SESSION['show_msg'] = showalert('danger', 'Неправильный логин или пароль', 'Попробуйте снова');
        ...
        <div class="row">
            <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                ...
                <div class="card card-primary">
                    <div class="card-header"><h4>Авторизация</h4></div>
