...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1')
{
    ...
    if ($isrecapv3 == 0)
    {
        $_SESSION['show_msg'] = showalert('warning', 'Ошибка!', 'Капча не разгадана. Попробуйте еще раз!');
        $redirval = "?res=rcapt";
    }
    elseif (count($sql) > 0)
    {
        $_SESSION['show_msg'] = showalert('danger', 'Ошибка!', 'Имя пользователя уже существует!');
        $redirval = "?res=exist";
    }
    else
    {
        ...
        {
            $_SESSION['show_msg'] = showalert('danger', 'Ошибка!', $LANG['g_invalidtoken']);
        ...
        {
            $_SESSION['show_msg'] = showalert('danger', 'Пароли не совпадают', 'Оба пароля должны быть одинаковыми. Пожалуйста, попробуйте еще раз!');
        ...
        {
            $_SESSION['show_msg'] = showalert('warning', 'Подсказка пароля', $passres);
            $redirval = "?res=errpass";
        }
    }
    redirpageto($redirval);
                ...
                <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            {
                                echo showalert('danger', 'Упс!', 'В связи с обслуживанием системы, в настоящее время мы не принимаем новую регистрацию!');
                            }
                            elseif ($cfgrow['validref'] == 1 && $sesref['id'] < 1)
                            {
                                echo showalert('warning', 'Упс!', 'Вы не можете зарегистрироваться без приглашения партнера!');
                            }
                            else
                            {
                                ...
                                <form method="POST" class="needs-validation" id="regmbrform">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <div class="invalid-feedback">
                                                Пожалуйста, выберите ваше имя пользователя
                                            </div>
                                        </div>
                                        <div class="form-group col-6">
                                            ...
                                            <input id="email" type="email" class="form-control" name="email"
                                                   ...
                                                   required>
                                            <div class="invalid-feedback">
                                                Пожалуйста, заполните адрес почты правильно
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            <label for="passwordconfirm" class="d-block">Пароль еще раз</label>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="agree" class="custom-control-input" id="agree"
                                                   required
                                                   data-validation-required-message="Вы должны согласится с условиями">
...
INI_HTML;
                            ...
                            <div class="mt-4 text-muted text-center">
                                <?php echo myvalidate($LANG['g_haveacc']); ?> <a href="login.php">Войти</a>
                            </div>
                        </div>
                    </div>
                </div>
