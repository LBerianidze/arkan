...
if (isset($FORM['getId']) and $FORM['getId'] != "") {
    ...
    $status_arr = array('0' => 'Неактивный', '1' => 'Активный', '2' => 'Ограничен', '3' => 'В ожидании');
    ...
    if ($rowstr['mpid'] < 1) {
        $markstatus = "<span class='alert alert-dark'>НЕЗАРЕГИСТРИРОВАН</span>";
    } else {
        if ($rowstr['mpstatus'] == 1) {
            $markstatus = "<span class='alert alert-success'>АКТИВНЫЙ</span>";
        } else {
            $markstatus = "<span class='alert alert-secondary'>НЕАКТИВНЫЙ</span>";
        }
    }

    if ($rowstr['mbrstatus'] != 1) {
        $markstatus .= "<span class='alert alert-danger' data-toggle='tooltip' title='Аккаунт не активен!'><i class='fa fa-fw fa-exclamation-triangle'></i></span>";
    }
        ...
        <div class="col-12 col-md-12 col-lg-6">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    <a href="javascript:;" onclick="location.href = 'index.php?hal=historylist&dohal=filter&doval=<?php echo myvalidate($rowstr['id']); ?>'" class="btn btn-sm btn-block btn-round btn-info" data-toggle="tooltip" title="<?php echo myvalidate($LANG['g_historylist']); ?>"><i class="fa fa-fw fa-vote-yea"></i> История</a>
                </div>
                <div class="col-sm-12 col-md-4">
                    <a href="javascript:;" onclick="location.href = 'index.php?hal=userlist&dohal=filter&doval=<?php echo myvalidate($rowstr['mpid']); ?>'" class="btn btn-sm btn-block btn-round btn-info" data-toggle="tooltip" title="<?php echo myvalidate($LANG['g_referrallist']); ?>"><i class="fa fa-fw fa-user-friends"></i> Партнер</a>
                </div>
                <div class="col-sm-12 col-md-4">
                    <a href="javascript:;" onclick="location.href = 'index.php?hal=genealogyview&loadId=<?php echo myvalidate($rowstr['mpid']); ?>'" class="btn btn-sm btn-block btn-round btn-info" data-toggle="tooltip" title="Genealogy Structure"><i class="fa fa-fw fa-sitemap"></i> Структура</a>
                </div>
            </div>
            ...
            <div class="card">
                <form method="post" class="needs-validation" novalidate="">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                <label>Сайт <?php echo myvalidate($showsite_cekicon); ?></label>
                        ...
                        <div class="row">
                            <div class="form-group col-12">
                                <label>Подписка на уведомления</label>
                    ...
                    <div class="card-footer bg-whitesmoke text-right">
                        <a href="javascript:;" onclick="location.href = '<?php echo myvalidate($backpage); ?>'" class="btn btn-warning" data-toggle="tooltip" title="Назад"><i class="fa fa-fw fa-undo-alt"></i> Назад</a>
                    </div>
            </div>
            </form>
        </div>
