                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="txbatch" id="txbatch" class="form-control" value="<?php echo isset($FORM['txbatch']) ? $FORM['txbatch'] : '' ?>" placeholder="ID транзакции">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="txmemo" id="txmemo" class="form-control" value="<?php echo isset($FORM['txmemo']) ? $FORM['txmemo'] : '' ?>" placeholder="Описание транзакции">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="txadminfo" name="txadminfo" id="txadminfo" class="form-control" value="<?php echo isset($FORM['txadminfo']) ? $FORM['txadminfo'] : '' ?>" placeholder="Ключевое слово">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="float-md-right">
                            <a href="index.php?hal=historylist&dohal=clear" class="btn <?php echo myvalidate($btnclorclear); ?>"><i class="fa fa-fw fa-redo"></i> Очистить<?php echo myvalidate($clearfilterusrstr); ?></a>
                            <button type="submit" name="submit" value="search" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-search"></i> Поиск</button>
                        </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col" nowrap><?php echo myvalidate($tblshort['txdatetm']); ?>Дата</th>
                    <th scope="col" nowrap><?php echo myvalidate($tblshort['txbatch']); ?>ID транзакции</th>
                    <th scope="col" nowrap><?php echo myvalidate($tblshort['txmemo']); ?>Описание</th>
                    <th scope="col" nowrap><?php echo myvalidate($tblshort['txamount']); ?>Сумма</th>
            ...
            <tbody>
                ...
                if (count($userData) > 0) {
                    ...
                    foreach ($userData as $val) {
                        ...
                        $overview = "<label>Инфо</label><div>" . $val['adminfo'] . "</div>";
                        ?>
                        <tr>
