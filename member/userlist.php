                ...
                <div class="card-header-action">
                    <div class="dropdown">
                        <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                            Показать список <span class="badge badge-light"><?php echo myvalidate($viewlnow); ?></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="index.php?hal=userlist&vlist=all">Все партнеры</a>
                            <a class="dropdown-item" href="index.php?hal=userlist&vlist=ref">Мои партнеры</a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" value="<?php echo isset($FORM['name']) ? $FORM['name'] : '' ?>" placeholder="Имя партнера">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="username" id="username" class="form-control" value="<?php echo isset($FORM['username']) ? $FORM['username'] : '' ?>" placeholder="Логин партнераа">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="email" name="email" id="useremail" class="form-control" value="<?php echo isset($FORM['email']) ? $FORM['email'] : '' ?>" placeholder="Почта партнера">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="float-md-right">
                            <a href="index.php?hal=userlist&dohal=clear" class="btn <?php echo myvalidate($btnclorclear); ?>"><i class="fa fa-fw fa-redo"></i> Очистить<?php echo myvalidate($clearfilterusrstr); ?></a>
                            <button type="submit" name="submit" value="search" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-search"></i> Найти</button>
                        </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            <thead>
                <tr>
                    <th scope="col">#</th>
                    <th scope="col" nowrap><?php echo myvalidate($tblshort['in_date']); ?>Дата</th>
                    <th scope="col" nowrap><?php echo myvalidate($tblshort['username']); ?>Логин</th>
                    <th scope="col" nowrap><?php echo myvalidate($tblshort['email']); ?>Почта</th>
                    ...
                    foreach ($userData as $val) {
                        ...
                        <tr>
                            ...
                            <td align="center" nowrap>
                                ...
                                <a href="index.php?hal=getuser&getId=<?php echo myvalidate($val['id']); ?>" class="btn btn-sm btn-info" data-toggle="tooltip" title="Посмотреть <?php echo myvalidate($val['username']); ?>"><i class="far fa-fw fa-id-badge"></i></a>
