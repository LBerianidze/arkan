...
if ($mbrstr['mpid'] > 0) {
    $mbractive_menu = <<<INI_HTML
                            <li class="menu-header">Аккаунт</li>
                            ...
                            <li{$menuactive['fillbalance']}><a class="nav-link" href="index.php?hal=fillbalance"><i class="fas fa-hand-holding-usd"></i> <span>{$LANG['m_fillbalance']}</span></a></li>
            ...
            <div class="main-wrapper">
                ...
                <nav class="navbar navbar-expand-lg main-navbar">
                    ...
                    <ul class="navbar-nav navbar-right">
                        <li class="dropdown dropdown-list-toggle invisible">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-title">Выбор языка</div>
                                {$langliststr}
                            </div>
                        </li>
                        ...
                        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-title">Онлайн {$logtimeago}</div>
                                <a href="index.php?hal=accountcfg#cfgtab3" class="dropdown-item has-icon">
                                    <i class="far fa-user-circle"></i> Профиль
                                </a>
                ...
                <div class="main-sidebar">
                    <aside id="sidebar-wrapper">
                        ...
                        <ul class="sidebar-menu">
                            <li class="menu-header">Основное</li>
                            ...
                            <li class="menu-header">Панель</li>
                            ...
                            <li class="menu-header">Настройки</li>
