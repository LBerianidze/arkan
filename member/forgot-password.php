...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1') {
    ...
    if ($mbrid > 0) {
        ...
        $_SESSION['show_msg'] = showalert('primary', 'Сброс пароля', 'Ссылка для сброса пароля была отправлена на почту');
    } else {
        $_SESSION['show_msg'] = showalert('danger', 'Почта указана неверно', 'Адрес электронной почты не распознан!<br />Попробуйте снова.');
    }
