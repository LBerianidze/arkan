...
//echo 'hereisis           '. password_hash( md5('arkan'),PASSWORD_DEFAULT) . '          ' . $cfgrow['admin_password'];
...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1')
{
    ...
    //echo 'hereisis           '. password_hash( md5($password)) . '          ' . $cfgrow['admin_password'];
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label"
                                               for="remember-me"><?php echo myvalidate($LANG['g_rememberme']); ?></label>
                                    </div>
                                </div>
