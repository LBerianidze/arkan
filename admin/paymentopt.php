...
if (isset($FORM['dosubmit']) and $FORM['dosubmit'] == '1') {
    ...
    if (count($sql) > 0) {
        if (!defined('ISDEMOMODE')) {
            ...
            $db->updateAll(DB_TBLPREFIX.'_paygates',array('manualpayfee'=>$manualpayfee,'manualpayname'=>$manualpayname));
            $db->updateAll(DB_TBLPREFIX.'_configs',array('wdrawfee'=>$manualpayfee.'|'.0));
            if ($update) {
