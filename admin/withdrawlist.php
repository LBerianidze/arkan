                        ...
                        <tr>
                            ...
                            <td align="center" nowrap>
                                <a href="javascript:;"
                                   ...
                                   data-content="<h6><?php echo myvalidate($val['txid']); ?>.<?php echo myvalidate($val['txbatch']); ?></h6><div>Recipient: <?php echo myvalidate($mbrstr['username']); ?></div><div class='text-small'>Account: <?php echo myvalidate($txpaytype); ?></div><div class='mt-2'><?php echo myvalidate($val['txmemo']); ?></div><div class='mt-2 text-info'><?php echo myvalidate($val['txadminfo']); ?></div>">
