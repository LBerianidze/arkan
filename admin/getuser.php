            ...
            <div class="card profile-widget">
                ...
                <div class="profile-widget-description">
                    ...
                    <div class="profile-widget-name">
                        <a href="<?php echo myvalidate($cfgrow['site_url']) . '/' . UIDFOLDER_NAME . '/' . $rowstr['username']; ?>" target="_blank" data-toggle="tooltip" title="<?php echo myvalidate($cfgrow['site_url']) . '/' . UIDFOLDER_NAME . '/' . $rowstr['username']; ?>"><i class="fas fa-fw fa-link"></i></a> <?php echo myvalidate($rowstr['username']); ?> <div class="text-muted d-inline font-weight-normal"><div class="slash"></div> <?php echo formatdate($rowstr['in_date'], 'dt'); ?></div>
                    </div>
